...
/// \file exception_caught_breakpoint.hpp
/// Contains definition of exception_caught_breakpoint class
...
class exception_caught_breakpoint: public code_breakpoint {
public:
    /// Constructor
    exception_caught_breakpoint(source_model & smdl, num_t i);

    /// Destructor, destroys object
    virtual ~exception_caught_breakpoint() override;

    /// Returns breakpoint name
    std::string name() const override;

    /// Returns function name used to set breakpoint
    static std::string function_name() { return "__cxa_begin_catch"; }
